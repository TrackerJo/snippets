                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      validator: (val) {
                                  ...
                                  child: SingleChildScrollView(
                                    child: AlertDialog(
                                      ...
                                      actions: [
                                        ...
                                        isLoadingPassword ? CircularProgressIndicator(color: ColorSys.secondary,) : ElevatedButton(
                                          onPressed: () async {
                                            HapticFeedback.mediumImpact();
                                            setState(() {
                                            ...
                                            //Change password
                                            String res = await Auth().changePassword(oldEmail, currentPasswordController.text, newPasswordController.text);
                                            if(res != "Done"){
                                              ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(res)));
                                            } else{
                                              ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: const Text("Password changed successfully")));
                                              Navigator.of(context).pop();
                                            }
                                            setState(() {
                        ...
                        isLoading ? Center(child: CircularProgressIndicator(color: ColorSys.primary,),) : ElevatedButton(
                          onPressed: () async {
                            HapticFeedback.mediumImpact();
                            setState(() {
                              isLoading = true;
                            ...
                            if(formKey.currentState!.validate()){
                              ...
                              if(oldDescription != descriptionController.text){
                                ...
                                //Show snackbar
                                ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: const Text("Description updated successfully")));
                              }
