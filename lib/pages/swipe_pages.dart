        ...
        return SizedBox(
          ...
          child: SingleChildScrollView(
            child: AlertDialog(
              ...
              title: const Text("Account Verification Before Deletion",
              ...
              child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      const SizedBox(height: 10),
                      const Text(
                        "I've been coding for about 7 years, and in that time I've made a few small video games, a programming language, an e-commerce store for a school, and so much more! I've even co-founded a company!",
                        style: TextStyle(
                            color: Colors.white,
                            fontSize: 15,
                            fontWeight: FontWeight.w500),
                      ...
                      ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            ...
                            shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(12),
                                side: BorderSide(
                                    color: ColorSys.primaryDark, width: 2)),
                      ...
                      child: Column(
                        children: [
                          Text(
                            "Customize Widgets",
                            style: TextStyle(
                                color: ColorSys.primary, fontSize: 20),
                          ),
                          const SizedBox(height: 20),
                          const Text(
                          ...
                          Row(
                            ...
                            children: [
                              WidgetGradientTile(
                                gradient: ColorSys.widgetBPGradient,
                                name: "bluePurple",
                                onTap: () {
                                  setState(() {
                              ...
                              WidgetGradientTile(
                                gradient: ColorSys.widgetBGGradient,
                                name: "blueGreen",
                                onTap: () {
                                  setState(() {
                              ...
                              WidgetGradientTile(
                                gradient: ColorSys.widgetORGradient,
                                name: "orangeRed",
                                onTap: () {
                                  setState(() {
                          ...
                          Row(
                            ...
                            children: [
                              WidgetGradientTile(
                                gradient: ColorSys.widgetYRGradient,
                                name: "yellowRed",
                                onTap: () {
                                  setState(() {
                              ...
                              WidgetGradientTile(
                                gradient: ColorSys.widgetPPGradient,
                                name: "pinkPurple",
                                onTap: () {
                                  setState(() {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          backgroundColor: ColorSys.background,
          title:
              Text("Share Feedback", style: TextStyle(color: ColorSys.primary)),
          content: SizedBox(
            width: 300,
            height: 300,
            child: Column(
