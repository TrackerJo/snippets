...
actor AppAlertBadgeManager {
    ...
    func setAlertBadge(number: Int) {
        ...
        UserDefaults.standard.set(number, forKey: "appBadge")
    }
    
    @MainActor
    func resetAlertBadgeNumber() {
        application.applicationIconBadgeNumber = 0
        UserDefaults.standard.set(0, forKey: "appBadge")
    }
    
    @MainActor
    func addAlertBadge() {
        var num = UserDefaults.standard.integer(forKey: "appBadge")
        num += 1
        UserDefaults.standard.set(num, forKey: "appBadge")
